...
ModelPath = os.path.join("modeldata", "masknonmask", "VGG16_MaskNonMask.h5")
LabelPath = os.path.join("modeldata", "masknonmask", "MaskNonMask_labels.txt")
...
class ModelInferenceAPI(Resource):
    ...
    def LocalInference(self, base64String, inferenceData={}):
        ...
        Pred_label, PredConfidence = custom_model.inferModel(image)
